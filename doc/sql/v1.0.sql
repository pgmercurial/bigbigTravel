...
CREATE TABLE `product` (
  ...
  `valid_start_date` varchar(10) NOT NULL DEFAULT '' COMMENT '产品有效起始时间,example:2019-05-01',
  `valid_end_date` varchar(10) NOT NULL DEFAULT '' COMMENT '产品有效终止时间,example:2019-06-01',
